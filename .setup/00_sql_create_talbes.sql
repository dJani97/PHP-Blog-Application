...
USE blog;
CREATE TABLE post(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, author varchar(100), title varchar(100), teaser varchar(250), body varchar(500), posted_on TIMESTAMP);
